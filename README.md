...
For documentation and manuals visit our [github.io page](https://biopet.github.io/krakenreporttojson).

# About


KrakenReportToJson is part of BIOPET tool suite that is developed at LUMC by [the SASC team](http://sasc.lumc.nl/).
...
For any question related to KrakenReportToJson, please use the
<a href='https://github.com/biopet/krakenreporttojson/issues'>github issue tracker</a>
or contact
